...
public class AntiqueAtlasConfig implements ConfigObject {
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "doSaveBrowsingPos", 
    		translatable = "text.autoconfig.navigate.option.doSaveBrowsingPos", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "autoDeathMarker", 
    		translatable = "text.autoconfig.navigate.option.autoDeathMarker", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "showDeathMarkers",
    		translatable = "text.autoconfig.navigate.option.showDeathMarkers", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "deathMarkerLimit",
    		translatable = "text.autoconfig.navigate.option.deathMarkerLimit", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "enableItemAtlas",
    		translatable = "text.autoconfig.navigate.option.enableItemAtlas", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "enablePlayerAtlas",
    		translatable = "text.autoconfig.navigate.option.enablePlayerAtlas", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "enableBiomeInspect",
    		translatable = "text.autoconfig.navigate.option.enableBiomeInspect", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "biomeInspectTexture",
    		translatable = "text.autoconfig.navigate.option.biomeInspectTexture", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "User Interface", name = "doScaleMarkers", 
    		translatable = "text.autoconfig.navigate.option.doScaleMarkers", side = ConfigSide.Shared)
    public boolean doScaleMarkers = false;

    @UnionConfig.Entry(group = "User Interface", name = "defaultScale", 
    		translatable = "text.autoconfig.navigate.option.defaultScale", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "userInterface", name = "minScale", 
    		translatable = "text.autoconfig.navigate.option.minScale", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "userInterface", name = "maxScale", 
    		translatable = "text.autoconfig.navigate.option.maxScale", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "User Interface", name = "doReverseWheelZoom", 
    		translatable = "text.autoconfig.navigate.option.doReverseWheelZoom", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "scanRadius", 
    		translatable = "text.autoconfig.navigate.option.scanRadius", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "forceChunkLoading", 
    		translatable = "text.autoconfig.navigate.option.forceChunkLoading", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "newScanInterval", 
    		translatable = "text.autoconfig.navigate.option.newScanInterval", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "doRescan", 
    		translatable = "text.autoconfig.navigate.option.doRescan", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "rescanRate", 
    		translatable = "text.autoconfig.navigate.option.rescanRate", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "doScanPonds", 
    		translatable = "text.autoconfig.navigate.option.doScanPonds", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "doScanRavines", 
    		translatable = "text.autoconfig.navigate.option.doScanRavines", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "debugRender", 
    		translatable = "text.autoconfig.navigate.option.debugRender", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "resourcePackLogging", 
    		translatable = "text.autoconfig.navigate.option.resourcePackLogging", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "appearance", name = "tileSize", 
    		translatable = "text.autoconfig.navigate.option.tileSize", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "appearance", name = "markerSize", 
    		translatable = "text.autoconfig.navigate.option.markerSize", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "appearance", name = "playerIconWidth", 
    		translatable = "text.autoconfig.navigate.option.playerIconWidth", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "appearance", name = "playerIconHeight", 
    		translatable = "text.autoconfig.navigate.option.playerIconHeight", side = ConfigSide.Shared)
