...
public class NetherPortalWatcher {
	...
	private void addPortalMarkerIfNone(Player player, Level world, int atlasID) {
		...
		AtlasAPI.getMarkerAPI().putMarker(world, false, atlasID, MarkerType.REGISTRY.getKey(netherPortalType), Component.translatable("gui.antiqueatlas.marker.netherPortal"), x, z);
	}
