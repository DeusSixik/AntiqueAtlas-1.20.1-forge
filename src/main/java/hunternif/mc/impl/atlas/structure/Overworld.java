...
public class Overworld {
    ...
    private static Collection<ChunkPos> aboveGround(Level world, @SuppressWarnings("unused") StructurePoolElement structurePoolElement, BoundingBox blockBox, StructurePiece piece) {
